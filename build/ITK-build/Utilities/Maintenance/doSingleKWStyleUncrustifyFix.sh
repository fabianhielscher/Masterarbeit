...
${UNCRUSTIFYBIN} -c /Users/fabianhielscher/Dev/Masterarbeit/code/build/ITK/Utilities/Maintenance/uncrustify_itk.cfg -l CPP -f ${file} | sed 's/  *##  */##/g' | sed 's/#  */#/g' > ${file}_uncrustify
...
KWSTYLE_EXECUTABLE-NOTFOUND -xml /Users/fabianhielscher/Dev/Masterarbeit/code/build/ITK-build/Utilities/KWStyle/ITK.kws.xml -v -o /Users/fabianhielscher/Dev/Masterarbeit/code/build/ITK/Utilities/KWStyle/ITKOverwrite.txt -gcc $file > ${KWERRORS}
...
if [ -f ${KWERRORS} ]; then
  ...
  if [ ${skipuncrustify} == "y" ]; then
    ${UNCRUSTIFYBIN} -c /Users/fabianhielscher/Dev/Masterarbeit/code/build/ITK/Utilities/Maintenance/uncrustify_itk.cfg -l CPP -f ${file} -o ${KWERRORS}_skip_uncrustify
  fi

...
HDF5 1.8 that was compiled on;
    Darwin 18.2.0 x86_64, using AppleClang C 10.0.1.10010046.
...
The contents of this directory are:
    ...
    HDF5-1.8.17-Darwin.dmg    - HDF5 Install Package

Installation
===========================================================================
1. Execute HDF5-1.8.17-Darwin.dmg
2. Follow prompts
===========================================================================
...
To test the installation with the examples;
    ...
    The default installation folder is defined as "/Users/fabianhielscher/Dev/Masterarbeit/code/build/ITK-prefix".
